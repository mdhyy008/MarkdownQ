package com.dabai.markdownq.translate;
...
public class TranslateUtil {
    ...
    class TranslateTask extends AsyncTask<Void, Void, String> {
        ...
        private MaterialDialog loadingDalog = null; // 这个请自己定义加载中对话框，或者干脆不使用
...
//            result = "翻译失败";
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            try {
                loadingDalog = new MaterialDialog.Builder(context)
                        .title("提示")
                        .content("正在调用Google翻译")
                        .progress(true, 0)
